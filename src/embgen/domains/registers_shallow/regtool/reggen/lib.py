...
def check_keys(
    ...
    if missing or unexpected:
        ...
        ustr = (
            "The following unexpected fields were found: {}.".format(
                ", ".join(unexpected)
            )
            if unexpected
            else ""
...
def check_str(obj: object, what: str) -> str:
    ...
    if not isinstance(obj, str):
        raise ValueError(
            "{} is of type {}, not a string.".format(what, type(obj).__name__)
        )
    return obj
...
def check_bool(obj: object, what: str) -> bool:
    ...
    if isinstance(obj, str):
        ...
        if as_bool is None:
            raise ValueError(
                "{} is {!r}, which cannot be parsed as a bool.".format(what, obj)
            )
        return as_bool
...
def check_list(obj: object, what: str) -> List[object]:
    ...
    if not isinstance(obj, list):
        raise ValueError(
            "{} is of type {}, not a list.".format(what, type(obj).__name__)
        )
    return obj
...
def check_int(obj: object, what: str) -> int:
    ...
    raise ValueError(
        "{} is of type {}, not an integer.".format(what, type(obj).__name__)
    )
...
def check_xint(obj: object, what: str) -> Optional[int]:
    ...
    if isinstance(obj, str):
        ...
        try:
            ...
            raise ValueError(
                '{} is {!r}, which is not "x", nor can it be parsed as an int.'.format(
                    what, obj
                )
            ) from None
