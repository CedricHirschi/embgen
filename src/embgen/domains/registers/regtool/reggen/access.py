...
SWACCESS_PERMITTED = {
    ...
    "rc": (
        "Read Only, reading clears",  # noqa: E241
        SwAccess.RC,
        SwWrAccess.WR,
        SwRdAccess.RC,
        False,
    ...
    "r0w1c": (
        "Read zero, Write with 1 clears",  # noqa: E241
        SwAccess.W1C,
        SwWrAccess.WR,
        SwRdAccess.NONE,
        False,
    ...
    "rw1s": (
        "Read, Write with 1 sets",  # noqa: E241
        SwAccess.W1S,
        SwWrAccess.WR,
        SwRdAccess.RD,
        False,
    ...
    "rw1c": (
        "Read, Write with 1 clears",  # noqa: E241
        SwAccess.W1C,
        SwWrAccess.WR,
        SwRdAccess.RD,
        False,
    ...
    "rw0c": (
        "Read, Write with 0 clears",  # noqa: E241
        SwAccess.W0C,
        SwWrAccess.WR,
        SwRdAccess.RD,
        False,
...
class SWAccess:
    def __init__(self, where: str, raw: object):
        ...
        try:
            ...
            raise ValueError(
                "Unknown swaccess key, {}, for {}.".format(self.key, where)
            ) from None
...
class HWAccess:
    def __init__(self, where: str, raw: object):
        ...
        try:
            ...
            raise ValueError(
                "Unknown hwaccess key, {}, for {}.".format(self.key, where)
            ) from None
