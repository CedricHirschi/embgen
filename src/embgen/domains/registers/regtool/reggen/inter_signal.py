...
from .lib import check_keys, check_name, check_str, check_optional_str, check_int
...
class InterSignal:
    ...
    def from_raw(what: str, raw: object) -> "InterSignal":
        ...
        default = check_optional_str(rd.get("default"), "default field of " + what)

        return InterSignal(
            name, desc, struct, package, signal_type, act, width, default
        )
